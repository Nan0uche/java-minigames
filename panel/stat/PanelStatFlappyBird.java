...
public class PanelStatFlappyBird extends JPanel {
    ...
    private String table = "flappybird";

    public PanelStatFlappyBird(String username) {
    ...
    public static void check(String username) {
        JFrame frame = new JFrame("Statistiques du jeu Flappy Bird");
        frame.setLocationRelativeTo(null);
        frame.setSize(400, 300);

        PanelStatFlappyBird statsPanel = new PanelStatFlappyBird(username);
