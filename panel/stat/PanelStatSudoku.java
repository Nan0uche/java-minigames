...
public class PanelStatSudoku extends JPanel {
    ...
    private String table = "sudoku";

    public PanelStatSudoku(String username) {
    ...
    public static void check(String username) {
        JFrame frame = new JFrame("Statistiques du jeu Sudoku");
        frame.setLocationRelativeTo(null);
        frame.setSize(400, 300);

        PanelStatSudoku statsPanel = new PanelStatSudoku(username);
