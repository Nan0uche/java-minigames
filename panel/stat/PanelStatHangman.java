...
public class PanelStatHangman extends JPanel {
    ...
    private String table = "hangman";

    public PanelStatHangman(String username) {
    ...
    public static void check(String username) {
        JFrame frame = new JFrame("Statistiques du jeu Pendu");
        frame.setLocationRelativeTo(null);
        frame.setSize(400, 300);

        PanelStatHangman statsPanel = new PanelStatHangman(username);
