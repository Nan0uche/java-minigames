...
import list.sudoku.SudokuGenerator;
import list.sudoku.SudokuPuzzle;
...
public class SudokuPanel extends JPanel {
	...
	public SudokuPanel() {
		...
		this.puzzle = new SudokuGenerator().generateRandomSudoku(PanelConfigSudoku.getSelectedPuzzleType());
		...
		this.setFocusable(true); // Assurez-vous que le panneau peut recevoir le focus pour détecter les événements de clavier
	}
