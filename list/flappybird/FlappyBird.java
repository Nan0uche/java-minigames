...
public class FlappyBird extends JPanel implements ActionListener, KeyListener {
    ...
    public FlappyBird(String usernamed) {
        username = usernamed;
        ...
        birdImg = new ImageIcon(getClass().getResource("./nyancat.gif")).getImage();
	...
	public void draw(Graphics g) {
        ...
        g.drawString("Score : " + String.valueOf((int) score), 0, 35);
        if (gameOver) {
            g.drawString("Game Over", 100, 300);
            g.drawString("Score : " + String.valueOf((int) score), 00, 35);
        }
